...
namespace ESourcing.Order.Consumers
{
    ...
    {
        private readonly IRabbitMQPersistentConnection _persistentConnecttion;
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public EventBusOrderCreateConsumer(IRabbitMQPersistentConnection persistentConnecttion, IMediator mediator, IMapper mapper)
        {
            _persistentConnecttion = persistentConnecttion ?? throw new ArgumentNullException(nameof(persistentConnecttion));
        ...
        public void Consume()
        {
            if (!_persistentConnecttion.IsConnected)
            {
                _persistentConnecttion.TryConnect();
            }

            var channel = _persistentConnecttion.CreateModel();
        ...
        {
            _persistentConnecttion.Dispose();
        }
    }
}
